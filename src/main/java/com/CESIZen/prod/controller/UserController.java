...
public class UserController {
    ...
    @Operation(summary = "Obtenir les informations de l'utilisateur connecté", description = "Retourne un UserDTO")
    ...
    @Operation(summary = "Modifier ses informations personnelles", description = "Retourne un UserDTO mis à jour")
    ...
    @Operation(summary = "Télécharger ses données personnelles (RGPD)", description = "Retourne un fichier JSON contenant les données")
    @GetMapping("/me/data")
    ...
    @Operation(summary = "Demander la suppression de ses données personnelles (RGPD)", description = "Supprime les données utilisateur")
